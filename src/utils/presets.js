// A preset ("set") is a named, reusable starting point for the customizer: the
// design parameters plus default tags. Images are excluded by default (a set is the
// reusable "look"), but can be opted in so people can reuse base/holo images too.
// Stored client-side in localforage so it works logged-out.
...
// imagePath marker that tells the renderer which to use. Optional in a set.
...
// default tags. If the set carries images, overlay those too; otherwise the
